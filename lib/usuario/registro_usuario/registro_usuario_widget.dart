                                ...
                                children: [
                                  ...
                                  Align(
                                    ...
                                    child: Padding(
                                      ...
                                      child: Text(
                                        FFLocalizations.of(context).getText(
                                          'hbjiirfp' /* Comencemos completando el form... */,
                                        ),
                                        style: FlutterFlowTheme.of(context)
                                            .labelMedium
                                            .override(
                                      ...
                                      Align(
                                        ...
                                        child: Padding(
                                          ...
                                          child: SizedBox(
                                            ...
                                            child: TextFormField(
                                              controller: _model
                                                  .confirmaclaveTextController,
                                              focusNode:
                                                  _model.confirmaclaveFocusNode,
                                              autofocus: true,
                                              autofillHints: const [
                                                AutofillHints.password
                                              ],
                                    ...
                                    child: Padding(
                                      ...
                                      child: FFButtonWidget(
                                        onPressed: () async {
                                          ...
                                          GoRouter.of(context)
                                              .prepareAuthEvent();
                                          if (_model.claveTextController.text !=
                                            ...
                                            ScaffoldMessenger.of(context)
                                              ...
                                              SnackBar(
                                                content: Text(
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                    'tgm817m2' /* Las contraseñas no coinciden */,
                                                  ),
                                                ),
                                              ),
                                            );
                                          ...
                                          final user = await authManager
                                            ...
                                            _model.claveTextController.text,
                                          );
                                          if (user == null) {
                                            return;
                                          }
                                            ...
                                            children: [
                                              TextSpan(
                                                text:
                                                    FFLocalizations.of(context)
                                                        .getText(
                                                  'jdn1og69' /* Si ya tienes una cuenta   */,
                                                ),
                      ...
                      decoration: BoxDecoration(
                        ...
                        image: const DecorationImage(
                          ...
                          image: CachedNetworkImageProvider(
                            'https://www.tdea.edu.co/images/tdea/fotos/campus/campus-06.jpg',
                          ),
                        ),
