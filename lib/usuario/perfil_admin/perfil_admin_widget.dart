        ...
        appBar: AppBar(
          ...
          title: Text(
            FFLocalizations.of(context).getText(
              '8bbey2lz' /* Perfil de Administración */,
            ),
        ...
        body: SafeArea(
          ...
          child: Column(
            ...
            children: [
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: Text(
                                  FFLocalizations.of(context).getText(
                                    'gamjts0z' /* Panel de Administacion */,
                                  ),
                                  style: FlutterFlowTheme.of(context)
                                      .bodyMedium
                                      .override(
              ...
              if (valueOrDefault<bool>(currentUserDocument?.esAdmin, false))
                Align(
